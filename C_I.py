...
if __name__ == '__main__':
    ...
    # plt.savefig('citdomain.jpg', format='jpg')
    # plt.savefig('citdomain.eps', format='eps', dpi=300)
    ...
    # plt.savefig('cifdomain.jpg', format='jpg')
    # plt.savefig('cifdomain.eps', format='eps', dpi=300)
    ...
    # plt.savefig('citfdomain.jpg', format='jpg')
    # plt.savefig('citfdomain.eps', format='eps', dpi=300)
